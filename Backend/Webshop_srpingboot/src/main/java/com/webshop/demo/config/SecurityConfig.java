    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests()
                .requestMatchers(HttpMethod.GET, "/products", "/products/*", "/Frontend/admin_users-panel.html").permitAll()
                .requestMatchers( "/users/register", "/users/login", "registrierung.html", "login.html", "index.html", "/users").permitAll()  // Allow access to registration and login endpoints
